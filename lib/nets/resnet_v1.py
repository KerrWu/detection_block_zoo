    ...
    def _image_to_head_with_fpn(self, is_training, reuse=None):
        ...
        with tf.variable_scope("fpn", reuse=reuse):
            ...
            with slim.arg_scope(resnet_arg_scope(is_training=is_training)):
                ...
                p5_up = slim.convolution2d_transpose(p5, 256, 1, stride=2)
                ...
                p4_up = slim.convolution2d_transpose(p4, 256, 1, stride=2)
                p3 = p4_up + p3
                ...
                p3_up = slim.convolution2d_transpose(p3, 256, 1, stride=2)
                p2 = p3_up + p2
